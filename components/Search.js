...
const Search = () => {
  ...
  const handleStockClick = (ticker) => {
    ...
    router.push(`/stock/${ticker}`); // Navigate to stock page
  };
  useEffect(() => {
      ...
      <div className='search-inner-container'>
                              ...
                              <ul className='similar-search-menu'>
                                  {responseData.map((result, index) => (
                                    <div className='similar-search-container' key={index}>
                                     ...
                                     <Link
                    className='similar-search-link'
                    href={`/stock/${result.ticker}`}
                    onClick={() => handleStockClick(result.ticker)} // Navigate with loading
                  >
                                                              <div className=''>
                                                        <div>
        ...
        {topStocks && topStocks.map((stock) => (
          <div key={stock.ticker}>
            <Link
              className='top-stock-link'
              href={`/stock/${stock.ticker}`}
              onClick={() => handleStockClick(stock.ticker)} // Navigate with loading
            >
